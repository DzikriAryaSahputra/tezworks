...
@section('title', 'Tambah Portofolio - Admin TezWorks')
@section('header', 'Tambah Portofolio Baru')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" id="demo_url" name="demo_url" value="{{ old('demo_url') }}" class="w-full px-4 py-3 bg-light-bg-sec dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-xl focus:ring-2 focus:ring-brand-blue/50 focus:border-brand-blue transition-all dark:text-dark-text" placeholder="https://...">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="w-full relative border-2 border-dashed border-light-border dark:border-dark-border rounded-2xl overflow-hidden group hover:border-brand-blue dark:hover:border-brand-cyan transition-colors bg-light-bg-sec dark:bg-dark-bg h-64 flex flex-col items-center justify-center cursor-pointer">
                        <input type="file" id="image" name="image" required accept="image/*" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" onchange="previewImage(this)">
                        ...
                        <div id="image-placeholder" class="text-center p-4">
                            ...
                            <p class="text-sm font-semibold text-light-text dark:text-dark-text">Klik untuk mengunggah gambar</p>
                            <p class="text-xs text-light-text-sec dark:text-dark-text-sec mt-1">PNG, JPG, WEBP (Max 2MB)</p>
                        </div>
                ...
                <div class="flex items-center gap-3 p-4 border border-light-border dark:border-dark-border rounded-xl bg-light-bg-sec/50 dark:bg-dark-bg/50">
                    <input type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-5 h-5 text-brand-blue border-light-border dark:border-dark-border rounded focus:ring-brand-blue dark:bg-dark-bg focus:ring-offset-dark-card">
