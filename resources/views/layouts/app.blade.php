      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="space-y-4 md:col-span-1">
          ...
          <p class="text-light-text-sec dark:text-dark-text-sec text-sm leading-relaxed">
            Studio pengembangan aplikasi dan website profesional yang menghadirkan solusi teknologi terbaik, andal, dan inovatif untuk bisnis Anda secara online & offline.
          </p>
          <!-- Social Icons -->
          <div class="flex gap-4">
            <a href="#" class="p-2 bg-light-bg dark:bg-dark-bg hover:text-brand-blue dark:hover:text-brand-cyan border border-light-border dark:border-dark-border rounded-lg text-light-text-sec dark:text-dark-text-sec transition-colors" aria-label="GitHub">
            ...
            <a href="#" class="p-2 bg-light-bg dark:bg-dark-bg hover:text-brand-blue dark:hover:text-brand-cyan border border-light-border dark:border-dark-border rounded-lg text-light-text-sec dark:text-dark-text-sec transition-colors" aria-label="LinkedIn">
            ...
            <a href="#" class="p-2 bg-light-bg dark:bg-dark-bg hover:text-brand-blue dark:hover:text-brand-cyan border border-light-border dark:border-dark-border rounded-lg text-light-text-sec dark:text-dark-text-sec transition-colors" aria-label="Instagram">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2.5 text-sm text-light-text-sec dark:text-dark-text-sec">
            <li class="flex items-center gap-2">
              ...
              <span>Jakarta, Indonesia (Online/Offline)</span>
            </li>
            <li class="flex items-center gap-2">
              ...
              <a href="mailto:hello@tezworks.id" class="hover:text-brand-blue dark:hover:text-brand-cyan">hello@tezworks.id</a>
            </li>
            <li class="flex items-center gap-2">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener" class="hover:text-brand-blue dark:hover:text-brand-cyan">WhatsApp Business</a>
            </li>
          </ul>
          <div class="pt-2">
